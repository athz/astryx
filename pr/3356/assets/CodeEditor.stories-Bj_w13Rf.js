import{a1 as e,ah as m}from"./iframe-BE04S3Ff.js";import{C as d}from"./CodeEditor-Cg2FN7ww.js";import"./preload-helper-Ct5FWWRu.js";import"./highlightRanges-DKvVY5_0.js";const x={title:"Lab/CodeEditor",component:d,tags:["autodocs"],argTypes:{language:{control:"select",options:["typescript","javascript","json","html","css","python","bash","php","hack","yaml","markdown","plaintext"]},size:{control:"select",options:["sm","md"]},hasLineNumbers:{control:"boolean"},isReadOnly:{control:"boolean"}}},g=`function greet(name: string): string {

import{aL as xa,ah as e,a1 as n,I as P,a7 as ha,e as fa,af as ce,a6 as va,ay as Sa}from"./iframe-DN0if_pv.js";import{F as ba}from"./Field-ZRZ118eW.js";import{a as We,b as _e,i as Re,c as L}from"./inputStyles.stylex-Bpqcd25J.js";import{u as Ta,C as Da}from"./Calendar-DrhF5FmA.js";import{u as Ia}from"./usePopover-BHnFyLFD.js";import{u as Ca}from"./useInputContainer-Cix3KUDn.js";import{i as wa,k as Oa,w as pe,D as ka}from"./plainDate-C-ANv9VG.js";import{p as ge}from"./dateParser-XTIqkafj.js";import{f as Va,b as ja,p as ye,i as w,c as Le,a as za}from"./timeParser-CAi7zy_b.js";import"./preload-helper-Ct5FWWRu.js";import"./FieldStatus-C42-KD4f.js";import"./useFocusTrap-VaRQrein.js";import"./useClickableContainer-DWGdmf8v.js";const xe={row:{k1xSpc:"astryx78zum5",kOIVth:"astryx1txdalj",$$css:!0},dateWrapper:{kUk6DE:"astryx98rzlu",kzQI83:null,kmuXW:null,kCS8Yb:"astryx1r8uery",$$css:!0},timeWrapper:{kUk6DE:"astryx98rzlu",kzQI83:null,kmuXW:null,kCS8Yb:"astryx1r8uery",$$css:!0}},Pe={sm:{kZKoxP:"astryx6k0iem",$$css:!0},md:{kZKoxP:"astryx1ueg155",$$css:!0},lg:{kZKoxP:"astryxssyfek",$$css:!0}};function he(a){if(!a)return{date:void 0,time:void 0};const t=a.indexOf("T");return t===-1?{date:a,time:void 0}:{date:a.slice(0,t),time:a.slice(t+1)}}function F(a,t){if(!(!a||!t))return`${a}T${t}`}function Ma(a){const t=new Date;return Le({hour:t.getHours(),minute:t.getMinutes(),second:t.getSeconds()},a)}function l({label:a,isLabelHidden:t=!1,description:r,isOptional:O=!1,isRequired:D=!1,isDisabled:C=!1,value:I,onChange:M,changeAction:k,isLoading:ne=!1,min:q,max:W,dateConstraints:fe,hasSeconds:p=!1,hourFormat:re="12h",timeIncrement:se=1,hasClear:Fe=!1,placeholder:Ae="Select a date",timePlaceholder:ve="Select a time",size:Ne,status:o,labelTooltip:Ee,numberOfMonths:He=1,width:$e,xstyle:Be,className:Ye,style:Ue,ref:Ke,...Xe}){const ie=xa(Ne,"md"),Se=e.useId(),Ze=e.useId(),be=e.useId(),Te=e.useId(),le=e.useRef(null),De=e.useRef(null),Ie=e.useRef(null),Ce=e.useRef(null),oe=e.useRef(void 0),[,we]=e.useTransition(),[ue,Oe]=e.useOptimistic(I),V=ne||ue!==I,c=C||V,Qe={warning:"warning",error:"error",success:"success"},Ge={warning:"warning",error:"error",success:"success"},Je=[r?be:null,o?.message?Te:null].filter(Boolean).join(" ")||void 0,g=e.useMemo(()=>he(q),[q]),y=e.useMemo(()=>he(W),[W]),s=e.useMemo(()=>he(ue),[ue]),ke=g.date,Ve=y.date,{isDateDisabled:_}=Ta({min:ke,max:Ve,dateConstraints:fe}),b=e.useMemo(()=>{if(!(!g.date||!g.time||!s.date))return s.date===g.date?g.time:void 0},[g.date,g.time,s.date]),T=e.useMemo(()=>{if(!(!y.date||!y.time||!s.date))return s.date===y.date?y.time:void 0},[y.date,y.time,s.date]),[v,j]=e.useState(null),je=e.useRef(s.date);s.date!==je.current&&(je.current=s.date,s.date!==oe.current&&(oe.current=void 0,v!==null&&j(null)));const ea=v!==null?v:s.date&&/^\d{4}-\d{2}-\d{2}$/.test(s.date)?wa(Oa(s.date),ka):"",aa=v===null||!v.trim()?!0:ge(v)!==null,[f,de]=e.useState(null),[ze,Me]=e.useState(!1),qe=re==="12h"?Va:ja,me=e.useMemo(()=>f!==null?f:s.time?qe(s.time,p):"",[f,s.time,qe,p]),ta=e.useMemo(()=>{if(f===null||!f.trim())return!0;const i=ye(f,p);return i?w(i,b,T):!1},[f,p,b,T]),na=e.useMemo(()=>ze&&!me?re==="12h"?"e.g., 2:30 PM":"e.g., 14:30":ve,[ze,me,re,ve]),x=e.useCallback(i=>{V||(M(i),k&&we(async()=>{Oe(i),await k(i)}))},[V,M,k,we,Oe]),u=Ia({dialogLabel:"Choose date",closeButtonLabel:"Close calendar",onHide:()=>le.current?.focus()}),ra=e.useCallback(()=>{c||(u.isOpen?u.hide():u.show())},[c,u]),sa=e.useCallback(()=>{!c&&!u.isOpen&&u.show({skipAutoFocus:!0})},[c,u]),z=e.useCallback((i,d)=>{let m=s.time??Ma(p);g.date&&i===g.date&&g.time&&(w(m,g.time,void 0)||(m=g.time)),y.date&&i===y.date&&y.time&&(w(m,void 0,y.time)||(m=y.time));const S=F(i,m);S&&x(S),d==="calendar"&&(j(null),u.hide())},[s.time,p,g,y,x,u]),ia=e.useCallback(i=>{const d=i.target.value;j(d);const h=ge(d);if(h&&pe(h)!==s.date&&!_(h)){const m=pe(h);oe.current=m,z(m,"input"),Ce.current?.navigateTo(m)}},[s.date,_,z]),R=e.useCallback(()=>{if(v===null)return;if(!v.trim()){I!==void 0&&x(void 0),j(null);return}const i=ge(v);if(i&&!_(i)){const d=pe(i);d!==s.date&&z(d,"input")}j(null)},[v,I,s.date,x,_,z]),la=e.useCallback(()=>{R()},[R]),oa=e.useCallback(i=>{i.key==="Escape"&&u.isOpen?(i.preventDefault(),u.hide()):i.key==="Enter"&&(i.preventDefault(),R())},[u,R]),ua=e.useCallback(i=>{const d=i.target.value;de(d);const h=ye(d,p);if(h&&w(h,b,T)&&h!==s.time&&s.date){const m=F(s.date,h);m&&x(m)}},[p,b,T,s.time,s.date,x]),da=e.useCallback(()=>Me(!0),[]),ma=e.useCallback(()=>{if(Me(!1),f===null)return;if(!f.trim()){de(null);return}const i=ye(f,p);if(i&&w(i,b,T)&&i!==s.time&&s.date){const d=F(s.date,i);d&&x(d)}de(null)},[f,p,b,T,s,x]),ca=e.useCallback(i=>{if(i.key==="ArrowUp"||i.key==="ArrowDown"){i.preventDefault();let d=s.time;if(!d){const S=new Date;d=Le({hour:S.getHours(),minute:S.getMinutes(),second:S.getSeconds()},p)}const h=i.key==="ArrowUp"?se:-se,m=za(d,h,p);if(w(m,b,T)&&s.date){const S=F(s.date,m);S&&x(S)}}},[s,p,se,b,T,x]),pa=e.useCallback(()=>{x(void 0),le.current?.focus()},[x]),{onClick:ga,onMouseUp:ya}=Ca({containerRef:Ie,inputRef:De,disabled:c});return n.jsxs(ba,{label:a,isLabelHidden:t,description:r,inputID:Se,descriptionID:r?be:void 0,isOptional:O,isRequired:D,isDisabled:C,status:o?{type:o.type,message:o.message,messageID:o.message?Te:void 0}:void 0,labelTooltip:Ee,statusVariant:"detached",width:$e,children:[n.jsxs("div",{...Xe,...va(Sa("date-time-input",{size:ie,status:o?.type??null}),ce(xe.row,Be),Ye,Ue),children:[n.jsxs("div",{ref:u.triggerRef,...ce(L.base,Pe[ie],xe.dateWrapper,c&&L.disabled,o&&Re[o.type],o&&_e[o.type],o&&We[o.type]),children:[n.jsx("button",{type:"button",onClick:ra,disabled:c,"aria-label":u.isOpen?"Close calendar":"Open calendar",...{0:{className:"astryx78zum5 astryx6s0dn4 astryxl56j7k astryx1717udv astryx1ghz6dp astryxc342km astryxng3xce astryxjbqb8w astryx1ypdohk astryxh6dtrn astryx1a2a7pz astryx1p25gnr astryx1y3gkto"},1:{className:"astryx78zum5 astryx6s0dn4 astryxl56j7k astryx1717udv astryx1ghz6dp astryxc342km astryxng3xce astryxjbqb8w astryxh6dtrn astryx1a2a7pz astryx1p25gnr astryx1y3gkto astryx1h6gzvc"}}[!!c<<0],children:n.jsx(P,{icon:"calendar",size:"sm",color:"secondary"})}),n.jsx("input",{ref:ha(Ke,le),id:Se,type:"text",role:"combobox",value:ea,onChange:ia,onBlur:la,onClick:sa,onKeyDown:oa,placeholder:Ae,disabled:c,"aria-describedby":Je,"aria-required":D===!0?"true":void 0,"aria-invalid":o?.type==="error"?"true":void 0,"aria-busy":V||void 0,"aria-expanded":u.isOpen,"aria-haspopup":"dialog","aria-controls":u.isOpen?u.id:void 0,"aria-autocomplete":"none",autoComplete:"off",...{0:{className:"astryx1lliihq astryx98rzlu astryxeuugli astryxc342km astryxng3xce astryx1717udv astryx9ynric astryxjm74w1 astryx6pjikd astryxw6l6zx astryx1tgivj0 astryxjbqb8w astryx1a2a7pz astryxeyghm5"},2:{className:"astryx1lliihq astryx98rzlu astryxeuugli astryxc342km astryxng3xce astryx1717udv astryx9ynric astryxjm74w1 astryx6pjikd astryxw6l6zx astryx1tgivj0 astryxjbqb8w astryx1a2a7pz astryxeyghm5 astryx1h6gzvc"},1:{className:"astryx1lliihq astryx98rzlu astryxeuugli astryxc342km astryxng3xce astryx1717udv astryx9ynric astryxjm74w1 astryx6pjikd astryxw6l6zx astryxjbqb8w astryx1a2a7pz astryxeyghm5 astryxv1l7n4"},3:{className:"astryx1lliihq astryx98rzlu astryxeuugli astryxc342km astryxng3xce astryx1717udv astryx9ynric astryxjm74w1 astryx6pjikd astryxw6l6zx astryxjbqb8w astryx1a2a7pz astryxeyghm5 astryx1h6gzvc astryxv1l7n4"}}[!!c<<1|!aa<<0]}),Fe&&I!==void 0&&!c&&n.jsx("button",{type:"button",onClick:pa,"aria-label":`Clear ${a}`,className:"astryx78zum5 astryx6s0dn4 astryxl56j7k astryx1717udv astryx1ghz6dp astryxc342km astryxng3xce astryxjbqb8w astryx1ypdohk astryxh6dtrn astryx1a2a7pz astryx1p25gnr astryx1y3gkto",children:n.jsx(P,{icon:"close",size:"sm",color:"secondary"})}),V&&n.jsx(fa,{size:"sm"}),o&&n.jsx(P,{icon:Qe[o.type],size:"md",color:Ge[o.type]})]}),n.jsxs("div",{ref:Ie,onClick:ga,onMouseUp:ya,...ce(L.base,Pe[ie],xe.timeWrapper,c&&L.disabled,o&&Re[o.type],o&&_e[o.type],o&&We[o.type]),children:[n.jsx("div",{className:"astryx78zum5 astryx6s0dn4 astryxl56j7k astryx2lah0s",children:n.jsx(P,{icon:"clock",size:"sm",color:"secondary"})}),n.jsx("input",{ref:De,id:Ze,type:"text",value:me,onChange:ua,onFocus:da,onBlur:ma,onKeyDown:ca,placeholder:na,disabled:c,"aria-label":"Time","aria-required":D===!0?"true":void 0,"aria-invalid":o?.type==="error"?"true":void 0,...{0:{className:"astryx1lliihq astryx98rzlu astryxeuugli astryxc342km astryxng3xce astryx1717udv astryx9ynric astryxjm74w1 astryx6pjikd astryxw6l6zx astryx1tgivj0 astryxjbqb8w astryx1a2a7pz astryxeyghm5"},2:{className:"astryx1lliihq astryx98rzlu astryxeuugli astryxc342km astryxng3xce astryx1717udv astryx9ynric astryxjm74w1 astryx6pjikd astryxw6l6zx astryx1tgivj0 astryxjbqb8w astryx1a2a7pz astryxeyghm5 astryx1h6gzvc"},1:{className:"astryx1lliihq astryx98rzlu astryxeuugli astryxc342km astryxng3xce astryx1717udv astryx9ynric astryxjm74w1 astryx6pjikd astryxw6l6zx astryxjbqb8w astryx1a2a7pz astryxeyghm5 astryxv1l7n4"},3:{className:"astryx1lliihq astryx98rzlu astryxeuugli astryxc342km astryxng3xce astryx1717udv astryx9ynric astryxjm74w1 astryx6pjikd astryxw6l6zx astryxjbqb8w astryx1a2a7pz astryxeyghm5 astryx1h6gzvc astryxv1l7n4"}}[!!c<<1|!ta<<0]})]})]}),u.render(n.jsx(Da,{handleRef:Ce,mode:"single",value:s.date,onChange:i=>z(i,"calendar"),min:ke,max:Ve,dateConstraints:fe,numberOfMonths:He}),{placement:"below",alignment:"start"})]})}l.displayName="DateTimeInput";l.__docgenInfo={description:`A combined date and time picker with side-by-side date input and

import{a1 as e,T as b,ah as i,B as E}from"./iframe-BCPTHVc3.js";import{M as s}from"./Markdown-BAoLkokm.js";import{L as w}from"./Link-C4IK7TPi.js";import"./preload-helper-Ct5FWWRu.js";import"./CodeBlock-BMRgSgDB.js";import"./highlightRanges-LwEZ1jfe.js";import"./CheckboxListItem-BbCnfg5g.js";import"./Field-BE_5q97b.js";import"./FieldStatus-Csq6k-tM.js";import"./List-C-vXR_Jg.js";import"./ListItem-Cb9Lz3rC.js";import"./Item-BVsLnggy.js";import"./computeTargetAndRel-BlG0ENK0.js";import"./CheckboxInput-YcpTcceo.js";import"./Blockquote-BVD0L5bZ.js";import"./Table-CD8JOK8f.js";import"./ContextMenu-CKQ-KtPk.js";import"./renderDropdownItems-BxdmVW2v.js";import"./Divider-BI8GzL6Z.js";import"./useListFocus-C71QUToY.js";import"./EmptyState-D1vS1YkD.js";import"./useStreamingText-BWK9QNiQ.js";import"./Citation-CadYKz5I.js";import"./Code-o922IgRc.js";import"./useInteractiveRole-C_-zwDwz.js";const se={title:"Core/Markdown",component:s,tags:["autodocs"],argTypes:{density:{control:"select",options:["default","compact"]},headingLevelStart:{control:"select",options:[1,2,3,4,5,6]},isStreaming:{control:"boolean"},display:{control:"select",options:["block","inline"]}}},f=["# Markdown Demo","","Renders **markdown** with *design-system-consistent* styling.","","## Features","","- Headings mapped to Astryx type scale","- **Bold**, *italic*, and ~~strikethrough~~ text","- [Links](https://example.com) with external detection","- Inline `code` and fenced code blocks","","### Code Block","","```typescript","interface User {","  id: string;","  name: string;","}","","function greet(user: User) {","  return `Hello, ${user.name}!`;","}","```","","### Blockquote","","> Design systems free teams to focus on problems that matter.","","### Table","","| Component | Status | Tests |","|:----------|:------:|------:|","| Markdown | Active | 73 |","| CodeBlock | Active | 44 |","","### Task List","","- [x] Parser","- [x] Renderer","- [ ] Storybook stories","","---","","1. First ordered item","2. Second ordered item"].join(`
...
}`,...x.parameters?.docs?.source}}};const ae=["Default","Compact","AIResponse","ShiftedHeadings","InlineDisplay","TableFocused","Streaming","WithImages","ContentAlignStart","ContentAlignCenter","InlinePlugins"];export{c as AIResponse,d as Compact,y as ContentAlignCenter,u as ContentAlignStart,o as Default,p as InlineDisplay,x as InlinePlugins,l as ShiftedHeadings,h as Streaming,m as TableFocused,g as WithImages,ae as __namedExportsOrder,se as default};
